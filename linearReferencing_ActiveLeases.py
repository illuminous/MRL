...
# Set workspace
env.workspace = "C:/GIS/linearReferencing/dailyPermits/linearReferencing.gdb"
...
##output to shapefile
arcpy.CopyFeatures_management("route_events", "C:/GIS/linearReferencing/dailyPermits/linearReferencing.gdb/activeLeases_MP_%s" %(switch))
